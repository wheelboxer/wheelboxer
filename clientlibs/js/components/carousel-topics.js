/*
*
* Advisor Assistance Carousel Topics component related javascript
*
 */

;(function( $ ) {
    $.fn.heightMatchCarousel = function( options ) {
        var $t = $(this),
            maxHeight = 0,
            defaults = {
                itemSelector: '.slide', //class of child container
                heightSelector: ['h3', 'p'] //class or element of container to match heights
            },
