...
;(function( $ ) {
	...
	/*
	*
	* Filtering Topics height matching component related javascript plugin
	*
	*/
	/* plugin start */
	$.fn.heightMatchFilter = function( options ) {
        var $t = $(this),
            maxHeight = 0,
            defaults = {
                itemSelector: '.filtering-topic', //class of child container
